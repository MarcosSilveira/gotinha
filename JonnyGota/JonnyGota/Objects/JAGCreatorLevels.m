...
+ (void)initializeLevel01ofWorld01onScene:(JAGPlayGameScene *)scene
{
    ...
    if (tiledMap){
        ...
        if (vida.gamePad) {
            ...
            temp.image.size=CGSizeMake(scene.frame.size.width*.4, scene.frame.size.height*.3);
            ...
            temp.image=[[SKSpriteNode alloc] initWithImageNamed:@"tuto5"];
            temp.image.size=CGSizeMake(scene.frame.size.width*.4, scene.frame.size.height*.3);
        ...
        temp.image.size=CGSizeMake(scene.frame.size.width*.4, scene.frame.size.height*.5);
...
+ (void)initializeLevel02ofWorld01onScene:(JAGPlayGameScene *)scene
{
    ...
    if (tiledMap){
        ...
        temp.image=[[SKSpriteNode alloc] initWithImageNamed:@"fogoHQ"];
        temp.image.size=CGSizeMake(scene.frame.size.width*0.4, scene.frame.size.height*0.3);
...
+ (void)initializeLevel04ofWorld01onScene:(JAGPlayGameScene *)scene
{
    ...
    if (tiledMap){
        ...
        temp.image=[[SKSpriteNode alloc] initWithImageNamed:@"buttons"];
        temp.image.size=CGSizeMake(scene.frame.size.width*0.4, scene.frame.size.height*0.3);
        ...
        temp.image=[[SKSpriteNode alloc] initWithImageNamed:@"brown"];
        temp.image.size=CGSizeMake(scene.frame.size.width*0.4, scene.frame.size.height*0.3);
        ...
        temp.image=[[SKSpriteNode alloc] initWithImageNamed:@"blue"];
        temp.image.size=CGSizeMake(scene.frame.size.width*0.4, scene.frame.size.height*0.3);
        ...
        temp.image=[[SKSpriteNode alloc] initWithImageNamed:@"green"];
        temp.image.size=CGSizeMake(scene.frame.size.width*0.4, scene.frame.size.height*0.3);
        ...
        temp.image=[[SKSpriteNode alloc] initWithImageNamed:@"doors"];
        temp.image.size=CGSizeMake(scene.frame.size.width*0.4, scene.frame.size.height*0.3);
...
+ (void)initializeLevel13ofWorld01onScene:(JAGPlayGameScene *)scene
{
    //    JSTileMap *map;
    //    TMXLayer *tile;
    //    TMXLayer *bg;
    
    JSTileMap* tiledMap = [JSTileMap mapNamed:@"map13.tmx"];
    if (tiledMap){
        ...
        JAGPressao *presao = [[JAGPressao alloc] initWithPosition:[scene.level calculateTileHalf:CGPointMake(16, 15)] withTipo:1 withSize:tiledMap.tileSize];
        
        JAGPressao *presao2 = [[JAGPressao alloc] initWithPosition:[scene.level calculateTileHalf:CGPointMake(14, 3)] withTipo:2 withSize:tiledMap.tileSize];
        
        JAGPressao *presao3 = [[JAGPressao alloc] initWithPosition:[scene.level calculateTileHalf:CGPointMake(9, 3)] withTipo:1 withSize:tiledMap.tileSize];
        ...
        JAGPorta *porta = [[JAGPorta alloc] initWithPosition:[scene.level calculateTileHalf:CGPointMake(16,3)] withDirection:2  withReverse:YES withTipo:1 withSize:tiledMap.tileSize];
        ...
        scene.level.chuva=[[JAGChuva alloc] initWithPosition:[scene.level calculateTile:CGPointMake(18, 9)] withSize:tiledMap.tileSize];
...
+ (void)initializeLevel14ofWorld01onScene:(JAGPlayGameScene *)scene
{
    //    JSTileMap *map;
    //    TMXLayer *tile;
    //    TMXLayer *bg;
    
    JSTileMap* tiledMap = [JSTileMap mapNamed:@"map14.tmx"];
    if (tiledMap){
        ...
        scene.gota = [[JAGGota alloc] initWithPosition:[scene.level calculateTile:CGPointMake(18, 1)] withSize:tiledMap.tileSize];
        ...
        JAGPressao *presao = [[JAGPressao alloc] initWithPosition:[scene.level calculateTileHalf:CGPointMake(18, 3)] withTipo:1 withSize:tiledMap.tileSize];
        
        JAGPressao *presao2 = [[JAGPressao alloc] initWithPosition:[scene.level calculateTileHalf:CGPointMake(6, 6)] withTipo:3 withSize:tiledMap.tileSize];
        
        JAGPressao *presao3 = [[JAGPressao alloc] initWithPosition:[scene.level calculateTileHalf:CGPointMake(14, 18)] withTipo:1 withSize:tiledMap.tileSize];
        ...
        JAGPorta *porta = [[JAGPorta alloc] initWithPosition:[scene.level calculateTileHalf:CGPointMake(5,15)] withDirection:2  withReverse:YES withTipo:1 withSize:tiledMap.tileSize];
...
+ (void)initializeLevel15ofWorld01onScene:(JAGPlayGameScene *)scene
{
    //    JSTileMap *map;
    //    TMXLayer *tile;
    //    TMXLayer *bg;
    
    JSTileMap* tiledMap = [JSTileMap mapNamed:@"map15.tmx"];
    if (tiledMap){
        ...
        JAGPressao *presao = [[JAGPressao alloc] initWithPosition:[scene.level calculateTileHalf:CGPointMake(4, 7)] withTipo:3 withSize:tiledMap.tileSize];
        
        JAGPressao *presao2 = [[JAGPressao alloc] initWithPosition:[scene.level calculateTileHalf:CGPointMake(1, 12)] withTipo:2 withSize:tiledMap.tileSize];
        
        
        
        JAGPressao *presao3 = [[JAGPressao alloc] initWithPosition:[scene.level calculateTileHalf:CGPointMake(1, 18)] withTipo:1 withSize:tiledMap.tileSize];
        ...
        JAGPorta *porta = [[JAGPorta alloc] initWithPosition:[scene.level calculateTileHalf:CGPointMake(5,13)] withDirection:3  withReverse:NO withTipo:1 withSize:tiledMap.tileSize];
        
        JAGPorta *porta2 = [[JAGPorta alloc] initWithPosition:[scene.level calculateTileHalf:CGPointMake(19,12)] withDirection:1  withReverse:NO withTipo:1 withSize:tiledMap.tileSize];
        ...
        [scene.camadaPersonagens addChild:porta2];
        
        
        
        JAGFogoEnemy *fogo = [[JAGFogoEnemy alloc] initWithPosition:[scene.level calculateTile:CGPointMake(6, 9)] withSize:tiledMap.tileSize];
        fogo.dano=10;
        ...
        NSMutableArray *paths = [[NSMutableArray alloc] init];
        [paths addObject:[NSValue valueWithCGPoint:CGPointMake(fogo.position.x+(tiledMap.tileSize.width*7), fogo.position.y)]];
        [paths addObject:[NSValue valueWithCGPoint:CGPointMake(fogo.position.x+(tiledMap.tileSize.width*7), fogo.position.y+(tiledMap.tileSize.width*3))]];
        [paths addObject:[NSValue valueWithCGPoint:CGPointMake(fogo.position.x+(tiledMap.tileSize.width*7), fogo.position.y-(tiledMap.tileSize.width*8))]];
        [paths addObject:[NSValue valueWithCGPoint:CGPointMake(fogo.position.x+(tiledMap.tileSize.width*7), fogo.position.y)]];
        [paths addObject:[NSValue valueWithCGPoint:CGPointMake(fogo.position.x, fogo.position.y)]];
        ...
        scene.level.chuva=[[JAGChuva alloc] initWithPosition:[scene.level calculateTile:CGPointMake(23, 11)] withSize:tiledMap.tileSize];
...
+ (void)initializeLevel16ofWorld01onScene:(JAGPlayGameScene *)scene
{
    //    JSTileMap *map;
    //    TMXLayer *tile;
    //    TMXLayer *bg;
    
    JSTileMap* tiledMap = [JSTileMap mapNamed:@"map16.tmx"];
    if (tiledMap){
        ...
        JAGPressao *presao = [[JAGPressao alloc] initWithPosition:[scene.level calculateTileHalf:CGPointMake(12, 5)] withTipo:3 withSize:tiledMap.tileSize];
        
        JAGPressao *presao2 = [[JAGPressao alloc] initWithPosition:[scene.level calculateTileHalf:CGPointMake(1, 10)] withTipo:1 withSize:tiledMap.tileSize];
        
        
        
        JAGPressao *presao3 = [[JAGPressao alloc] initWithPosition:[scene.level calculateTileHalf:CGPointMake(13, 15)] withTipo:1 withSize:tiledMap.tileSize];
        ...
        JAGPorta *porta = [[JAGPorta alloc] initWithPosition:[scene.level calculateTileHalf:CGPointMake(3,18)] withDirection:4  withReverse:NO withTipo:1 withSize:tiledMap.tileSize];
        ...
        JAGFogoEnemy *fogo = [[JAGFogoEnemy alloc] initWithPosition:[scene.level calculateTile:CGPointMake(7, 15)] withSize:tiledMap.tileSize];
        fogo.dano=10;
...
+ (void)initializeLevel17ofWorld01onScene:(JAGPlayGameScene *)scene
{
    ...
    if (tiledMap){
        ...
        scene.gota = [[JAGGota alloc] initWithPosition:[scene.level calculateTile:CGPointMake(9, 1)] withSize:tiledMap.tileSize];
        ...
        JAGPressao *presao = [[JAGPressao alloc] initWithPosition:[scene.level calculateTileHalf:CGPointMake(11, 1)] withTipo:1 withSize:tiledMap.tileSize];
        
        JAGPressao *presao2 = [[JAGPressao alloc] initWithPosition:[scene.level calculateTileHalf:CGPointMake(14, 3)] withTipo:3 withSize:tiledMap.tileSize];
        
        
        
        JAGPressao *presao3 = [[JAGPressao alloc] initWithPosition:[scene.level calculateTileHalf:CGPointMake(7, 3)] withTipo:3 withSize:tiledMap.tileSize];
        ...
        JAGPorta *porta = [[JAGPorta alloc] initWithPosition:[scene.level calculateTileHalf:CGPointMake(16,4)] withDirection:1  withReverse:YES withTipo:1 withSize:tiledMap.tileSize];
        ...
        NSMutableArray *paths = [[NSMutableArray alloc] init];
        [paths addObject:[NSValue valueWithCGPoint:CGPointMake(fogo.position.x, fogo.position.y- (tiledMap.tileSize.height*7))]];
        ...
        scene.level.chuva=[[JAGChuva alloc] initWithPosition:[scene.level calculateTile:CGPointMake(18, 2)] withSize:tiledMap.tileSize];
...
+ (void)initializeLevel18ofWorld01onScene:(JAGPlayGameScene *)scene
{
    ...
    if (tiledMap){
        ...
        JAGPressao *presao = [[JAGPressao alloc] initWithPosition:[scene.level calculateTileHalf:CGPointMake(8, 14)] withTipo:2 withSize:tiledMap.tileSize];
        
        [scene.level.botoes addObject:presao];
        
        JAGPorta *porta = [[JAGPorta alloc] initWithPosition:[scene.level calculateTileHalf:CGPointMake(7,6)] withDirection:4  withReverse:YES withTipo:1 withSize:tiledMap.tileSize];
        ...
        [paths addObject:[NSValue valueWithCGPoint:CGPointMake(fogo.position.x, fogo.position.y + (tiledMap.tileSize.height*2))]];
        [paths addObject:[NSValue valueWithCGPoint:CGPointMake(fogo.position.x - (tiledMap.tileSize.width*2), fogo.position.y + (tiledMap.tileSize.height*2))]];
        [paths addObject:[NSValue valueWithCGPoint:CGPointMake(fogo.position.x, fogo.position.y + (tiledMap.tileSize.height*2))]];
        [paths addObject:[NSValue valueWithCGPoint:CGPointMake(fogo.position.x, fogo.position.y)]];
